...
namespace aoe::core {
  ...
  protected:
     ...
     */
    virtual auto create_archer() -> archer* = 0;
     ...
     */
    virtual auto create_cavalry_archer() -> cavalry_archer* = 0;
     ...
     */
    virtual auto create_hand_cannoneer() -> hand_cannoneer* = 0;
  public:
     ...
     */
    auto create_unit(unit::type type) -> unit*;
  };
}
